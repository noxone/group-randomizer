(function (root, factory) {
  ...
  var decodeFromDynamic_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-jsLegacy.kotlinx.serialization.json.decodeFromDynamic_is5yld$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
  ...
  var encodeToDynamic_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-jsLegacy.kotlinx.serialization.json.encodeToDynamic_eahrye$', wrapFunction(function () {
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
  ...
  DynamicObjectEncoder.prototype.beginStructure_24f42q$ = function (descriptor) {
    ...
    if (this.writePolymorphic_0) {
      this.writePolymorphic_0 = false;
      this.current_0.jsObject[this.json.configuration_8be2vx$.classDiscriminator] = descriptor.serialName;
