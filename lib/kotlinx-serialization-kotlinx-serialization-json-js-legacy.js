(function (root, factory) {
  ...
  JsonLexer.prototype.tryConsumeNotNull = function () {
    var current = this.skipWhitespaces_0();
    var len = this.source_0.length - current | 0;
    if (len < 4)
      return true;
    for (var i = 0; i <= 3; i++) {
    ...
    if (len > 4 && charToTokenClass(this.source_0.charCodeAt(current + 4 | 0)) === TC_OTHER)
      return true;
  ...
  JsonLexer.prototype.consumeStringLenientNotNull = function () {
  ...
  function findActualSerializer($receiver, serializer, value) {
    ...
    var actualSerializer = findPolymorphicSerializer(casted, $receiver, value);
  ...
  AbstractJsonTreeDecoder.prototype.decodeTaggedInline_gaombr$ = function (tag, inlineDescriptor) {
    return get_isUnsignedNumber(inlineDescriptor) ? new JsonDecoderForUnsignedTypes(new JsonLexer(this.getPrimitiveValue_0(tag).content), this.json) : NamedValueDecoder.prototype.decodeTaggedInline_gaombr$.call(this, tag, inlineDescriptor);
  };
  ...
  JsonLiteralSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    ...
    if (value.isString) {
      ...
      encoder.encodeInline_24f42q$(serializer_0(ULong_init.Companion).descriptor).encodeLong_s8cxhz$(tmp$_0.data);
      return;
  ...
  function JsonObjectSerializer$JsonObjectDescriptor() {
    ...
    this.$delegate_p32uvu$_0 = MapSerializer(serializer_3(kotlin_js_internal_StringCompanionObject), JsonElementSerializer_getInstance()).descriptor;
  ...
  DynamicInput.prototype.decodeElementIndex_24f42q$ = function (descriptor) {
    ...
    while (this.currentPosition_0 < descriptor.elementsCount) {
      ...
      if (this.hasName_0(name) && (!this.json.configuration.coerceInputValues || !this.coerceInputValue_0(descriptor, this.currentPosition_0 - 1 | 0, name)))
