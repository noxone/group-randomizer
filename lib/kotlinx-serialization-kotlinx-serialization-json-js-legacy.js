(function (root, factory) {
  ...
  JsonIteratorWsSeparated.prototype.next = function () {
    return (new StreamingJsonDecoder(this.json_0, WriteMode$OBJ_getInstance(), this.lexer_0, this.deserializer_0.descriptor, null)).decodeSerializableValue_w63s0f$(this.deserializer_0);
  };
  ...
  JsonIteratorArrayWrapped.prototype.next = function () {
    ...
    return input.decodeSerializableValue_w63s0f$(this.deserializer_0);
  };
  ...
  var decodeToSequenceByReader_0 = defineInlineFunction('kotlinx-serialization-kotlinx-serialization-json-js-legacy.kotlinx.serialization.json.internal.decodeToSequenceByReader_asxqzy$', wrapFunction(function () {
    ...
    var getReifiedTypeParameterKType = Kotlin.getReifiedTypeParameterKType;
    var decodeToSequenceByReader = _.kotlinx.serialization.json.internal.decodeToSequenceByReader_r1ep7r$;
    var serializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.serializer_ca95z9$;
    var KSerializer = _.$$importsForInline$$['kotlinx-serialization-kotlinx-serialization-core-js-legacy'].kotlinx.serialization.KSerializer;
    var throwCCE = Kotlin.throwCCE;
  ...
  function ArrayAsSequence(buffer) {
    this.buffer = buffer;
    this.length_nwndaq$_0 = this.buffer.length;
  }
  ...
  function ReaderJsonLexer(reader, charsBuffer) {
    if (charsBuffer === void 0)
      charsBuffer = Kotlin.charArray(16384);
    AbstractJsonLexer.call(this);
    this.reader_0 = reader;
    this.threshold_0 = 128;
    this.source_u10a4u$_0 = new ArrayAsSequence(charsBuffer);
    this.preload_0(0);
  }
  ...
  ReaderJsonLexer.prototype.appendRange_vux9f0$ = function (fromIndex, toIndex) {
    this.escapedString_0.appendRange_8chfmy$(this.source.buffer, fromIndex, toIndex);
  };
  ...
  package$internal.JsonIterator_p16vat$ = JsonIterator;
  ...
  package$internal.decodeByReader_p4vdsg$ = decodeByReader;
  package$internal.decodeToSequenceByReader_r1ep7r$ = decodeToSequenceByReader;
  ...
  package$internal.decodeStringToJsonTree_rejhg9$ = decodeStringToJsonTree;
